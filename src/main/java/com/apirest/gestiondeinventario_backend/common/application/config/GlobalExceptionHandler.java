package com.apirest.gestiondeinventario_backend.common.application.config;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<BaseResponseDto> handleValidationException(
        ...
        return ResponseEntity.badRequest().body(BaseResponseDto.error("Bad Request", errors));
    }
}
